...
import s from "./InductryTransport.module.css";

import img1 from "../../../img/Renewables/inductry-transport/img1.jpg";
import img2 from "../../../img/Renewables/inductry-transport/img2.jpg";

const InductryTransport = () => {
  return (
    <div className="container">
      <Title name={"Inductry Transport"} />
